    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid nvv">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Online Quiz Portal</b></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(@$_GET['q']==0)
                {
                   echo "<h1> WELCOME TO ADMIN AREA ". $_SESSION['name']. '</h1>';
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div style="padding: 10px;">
                                    <input type="date" name="da" id="date" value="2023-01-01">
                                    <input type="time" name="ti" id="time" value="00:00">
                                </div>
                            ...
                            echo '<b>Question number&nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input name="tm'.$i.'" type="number" placeholder = "Give Time in Seconds" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
